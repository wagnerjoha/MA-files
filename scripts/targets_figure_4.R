...
ess_data <- data.frame(
  ESS = c(
    ...
    simulation_results_list[[2]][[1]]$ESS / (simulation_results_list[[2]][[1]]$iteration * 10),
    simulation_results_list[[3]][[1]]$ESS / (simulation_results_list[[3]][[1]]$iteration * 10),
    simulation_results_list[[4]][[1]]$ESS / (simulation_results_list[[4]][[1]]$iteration * 10)
  ),
