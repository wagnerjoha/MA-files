...
ess_data <- data.frame(
  ESS = c(
    simulation_results[[1]]$pca_results[[1]]$ESS / (simulation_results[[1]]$pca_results[[1]]$iteration * 10),
    simulation_results[[2]]$pca_results[[1]]$ESS / (simulation_results[[2]]$pca_results[[1]]$iteration * 10),
    simulation_results[[3]]$pca_results[[1]]$ESS / (simulation_results[[3]]$pca_results[[1]]$iteration * 10),
    simulation_results[[4]]$pca_results[[1]]$ESS / (simulation_results[[4]]$pca_results[[1]]$iteration * 10)
  ),
